    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-edit"></i> แก้ไขอู่ซ่อมรถ</div>
        <div class="card-body">

    <?php echo form_open('member/update_company/'.$rs['company_id']); ?>
  <table class="table">
  <tr>
      <td><label for="type_company">ประเภทอู่ซ่อมรถ :</label></td>        
      <td><input type="text" class="form-control" id="type_company" name="type_company" value = "<?php echo $rs['type_company'] ?>"></td>
