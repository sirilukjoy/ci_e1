    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> การอนุมัติ</div>
        <div class="card-body">

         <?php echo form_open('member/update_allow/'.$rs['booking_id']); 
         // echo anchor('member/update');
  ?>
            <label for="exampleInputLastName">สถานะ :</label>
            <input type="checkbox" name="status_allow" value="อนุมัติแล้ว"> อนุมัติ
            <input type="checkbox" name="status_allow" value="ไม่อนุมัติ"> ไม่อนุมัติ<br>
            <br>
            <a href="allow.php"><button type="submit" class="btn btn-success"></a>บันทึกการอนุมัติ</button>
            <?php
                echo form_close();
            ?>
