    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> เพิ่มรายชื่ออู่ซ่อมรถ</div>
        <div class="card-body">

        <form action ="add_company_add" class="table">
     <table>
      <tr>
        <td><label for="type_company">ประเภทอู่ซ่อมรถ :</label></td>
        <td><input class="form-control" id="type_company" name="type_company" type="text" placeholder="type_company" data-validation-required-message="Please enter your type_company."></td>
      ...
      <tr>
        <td><label for="tel">โทรศัพท์ :</label></td>
