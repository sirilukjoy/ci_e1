  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">ประเภทน้ำมัน</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> เพิ่มประเภทน้ำมัน</div>
        <div class="card-body">

        <form action ="add_fuel_add" class="table">
     <table>
      <tr>
        <td><label for="type_fuel">ประเภทน้ำมัน :</label></td>
        <td><input class="form-control" id="type_fuel" name="type_fuel" type="text" placeholder="type_fuel" data-validation-required-message="Please enter your type_fuel."></td>
        <td><label for="price_fuel">ราคา :</label></td>
        <td><input class="form-control" id="price_fuel" name="price_fuel" type="text" placeholder="price_fuel" data-validation-required-message="Please enter your price_fuel."></td>
      </tr>         
      <tr>       
