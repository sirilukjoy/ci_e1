  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">คืนรถยนต์</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> คืนรถยนต์</div>
        <div class="card-body">

         <?php echo form_open('member/update_return/'.$rs['car_id']); 
         // echo anchor('member/update');
  ?>
            <label for="exampleInputLastName">สถานะ :</label>
            <input type="checkbox" name="status" value="ว่าง"> คืนรถ<br>
            <td><a href="return_car.php"><button type="submit" class="btn btn-success"></a>บันทึก</button></td>
            <?php
                echo form_close();
            ?>
