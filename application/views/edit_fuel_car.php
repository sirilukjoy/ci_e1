    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-edit"></i> แก้ไขประเภทน้ำมัน</div>
        <div class="card-body">

    <?php echo form_open('member/update_fuel/'.$rs['fuel_id']); ?>
  <table class="table">
  <tr>
      <td><label for="type_fuel">ประเภทน้ำมัน :</label></td>        
      <td><input type="text" class="form-control" id="type_fuel" name="type_fuel" value = "<?php echo $rs['type_fuel'] ?>"></td>
      <td><label for="price_fuel">ราคา :</label></td>
      <td><input type="text" class="form-control" id="price_fuel" name="price_fuel" value = "<?php echo $rs['price_fuel'] ?>"></td>
  </tr>
  <tr>
