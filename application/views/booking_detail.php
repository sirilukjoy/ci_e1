    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
         ...
         <?php echo form_open('member/update_booking/'.$rs['car_id']); 
         // echo anchor('member/update');
  ?>
            <label for="exampleInputLastName">สถานะ :</label>
            <input type="checkbox" name="status" value="จองแล้ว"> จอง<br>
            <a href="detail_booking_car.php"><button type="submit" class="btn btn-success"></a>ตกลง</button>
            <?php
                echo form_close();
            ?>
